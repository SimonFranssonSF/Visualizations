...
#include "Assignment51.h"                  // <--- include your header file
//--------------------------------------------- // 
...
//
                                                //
IMPLEMENT_GEOX_CLASS( Assignment51, 0 )    // <--- names the class, sets version number to zero.
{                                               //      increment later if you add properties and still want to read old example files
   BEGIN_CLASS_INIT( Assignment51 );       // <--- starts the properties declartion
	...
	ADD_NOARGS_METHOD(Assignment51::euler);
	ADD_NOARGS_METHOD(Assignment51::rungeKutta);


}                                               //
                                                //
QWidget* Assignment51::createViewer()
{
    ...
    return viewer;
                                                ...
                                                //
                                                //
Assignment51::Assignment51()          // <--- constructor - set reasonable default parameters
{
	xStart = 1; 
	yStart = 0;
	maxDistance = 5;
	...
	rkSteps = 30;
                                                ...
                                                //
Assignment51::~Assignment51()         // <--- destructor - often empty for our experiments
{
                                               //
}                                               //

void Assignment51::euler()
{
